...
void setUUID(void)
{
		Internal_ReadFlash(ID_FLASH_ADDR, (uint8_t *) &parameter_.register_id, sizeof(parameter_.register_id));
	
//	printf("PhoneNumber == \"%s\" \r\n",parameter_.register_id.PhoneNumber);
//	printf("TerminalId == \"%s\" \r\n",parameter_.register_id.TerminalId);
	
	setTerminalPhoneNumber(parameter_.register_id.PhoneNumber, 12);
	setTerminalId(parameter_.register_id.TerminalId, 8);
